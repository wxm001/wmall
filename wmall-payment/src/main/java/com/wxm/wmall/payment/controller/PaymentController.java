package com.wxm.wmall.payment.controller;
...
import com.wxm.wmall.payment.config.AlipayConfig;
...
public class PaymentController {
    ...
    public String aliPayCallBackReturn(HttpServletRequest request, ModelMap modelMap){
        ...
        if(StringUtils.isNotBlank(sign)){
            ...
            // 更新用户的支付状态
            paymentService.updatePayment(paymentInfo);//支付成功后，引起系统服务-》订单服务更新-》库存服务-》物流
